...
>>>>>>> 2fd0876d819724e2b20ebe3348b1334f621a7794
  ...
  const runSequentialMultiInsurerAutomation = (onComplete) => {
    ...
    setAutomationStep('[1/4] Opening ICICI Lombard Gateway (:9001)... Autofilling vehicle & calculating quote');
    ...
    setTimeout(() => {
      ...
      setAutomationStep('[2/4] Opening ACKO General Gateway (:9002)... Autofilling risk factors & querying quote');
    }, 2800);
    ...
    setTimeout(() => {
      ...
      setAutomationStep('[3/4] Opening TATA AIG Gateway (:9003)... Submitting coverage & deductible terms');
    }, 5600);
    ...
    setTimeout(() => {
      ...
      setAutomationStep('[4/4] Opening HDFC ERGO Gateway (:9004)... Extracting final actuarial quotation');
    }, 8400);
...
>>>>>>> 2fd0876d819724e2b20ebe3348b1334f621a7794
        ...
        >
          ...
          <p style={{ fontSize: 13, color: '#555555', margin: '0 0 16px', lineHeight: 1.5 }}>
            You can get insurance quotes from all 4 underwriters in <strong>under 60 seconds without form filling</strong> by speaking with Euler Voice Advisor.
          </p>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 26 }}>
          ...
          <h1 style={{ fontSize: 'clamp(26px, 3.5vw, 36px)', fontWeight: 900, color: '#1C1C1C', margin: '0 0 8px', letterSpacing: '-0.02em' }}>
            {hasResults ? 'Real-Time Insurer Quotations' : 'Compare 4 Insurers in Real Time'}
          </h1>
              ...
              >
                {loading ? (
                  <>
                    ...
                    <span>Automating & Querying 4 Insurers...</span>
                  </>
                ) : (
                  <>
                    <span>Compare 4 Insurers in Real-Time</span>
